...
class FileManager:
    def __init__(self, model_size):
        ...
        self.model_dir = os.path.join(Config.RUNS_DIR, Config.DATASET, model_size)
        self.pretrained_weights = os.path.join('Weights', self.model_size)
        self.metrics_path = os.path.join(self.model_dir, Config.METRICS_FILE)
