...
def GAC_active_contour(x, y, s, input_path, BWoutput_pathGAC):
    ...
    init_ls = ms.circle_level_set(img.shape, (y, x), s)

    # Callback for visual plotting
    callback = visual_callback_2d(img)

    # MorphGAC.
    array = ms.morphological_geodesic_active_contour(gimg, iterations=200,
...
def CV_active_contour(x, y, s, input_path, BWoutput_pathCV):
    ...
    array = ms.morphological_chan_vese(img, iterations=200,
                               init_level_set=init_ls,
...
if __name__ == '__main__':
    ...
    input_folder = "Coordenates/CenterPoints"
    ...
    for txt in txtFiles:
        ...
        with open(input_file, 'r') as file:
            ...
            input_path = 'DatabaseImages/InBreast/Processed/contrast_' + image_name
            BWoutput_pathCV = 'Masks/InBreast_Masks/ActiveCountourMasks/CV/mask_CVBW_' + category + '_' + file_name
            BWoutput_pathGAC = 'Masks/InBreast_Masks/ActiveCountourMasks/GAC/mask_GACBW_' + category + '_' + file_name

            GAC_active_contour(x, y, s, input_path, BWoutput_pathGAC)
            CV_active_contour(x, y, s, input_path, BWoutput_pathCV)
